...
describe('App catalog actions', () => {
  ...
  it('renders server release details with readable roles, merged artists, and cover actions', async () => {
...
function searchResponseWithRelease() {
...
function graphResponseForReleaseWithDuplicateArtists() {
  return h.jsonResponse({
    entity: {
      id: 'release-stripped',
      type: 'release',
...
function releaseDetailWithoutCover() {
  return h.jsonResponse({
    id: 'release-stripped',
    title: 'Stripped',
    type: 'standalone',
